package iu.LCAC.Member.action.Concretes.DEResultActions.Init_GN_Section;
...
public class Initialize_GN_TabPanes_Action extends AbstActionMember {

    static final String jsonFolderPathString = "./json/DE";

    public Initialize_GN_TabPanes_Action(String action_name, String short_name) {
    ...
    public void perform(ActionEvent action_event) {
        ...
        if (cmd_and_args.length > 3) {
            ...
            GN_SubTabsHolder subTabsHolder =
                    (GN_SubTabsHolder) this.cholderMediator.getInstanceOfAMember("sub_tabs_holder_GN");
