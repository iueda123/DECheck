...
public class One_ARNSL_Style_Pane extends One_DEQAResult_Pane_Abs {
    ...
    public One_ARNSL_Style_Pane(String jsonFolderPathStr, String jsonName, String sectionName, String subSectionName) {
    ...
    public void copyToTheHumanDEQAResultPane() {
        ...
        for (One_DEQAResult_Pane_Abs one_deqaResult_pane_abs : deqaPanes) {
            ...
            if (one_deqaResult_pane_abs.getJsonName().toLowerCase().contains("human")) {
                ...
                ((One_ARNSL_Style_Pane) one_deqaResult_pane_abs).loadJson(); //これがないと他のSubSectionPanelで変更が加えられた後に一度loadボタンを押さなくてはならなくなる。

                ((One_ARNSL_Style_Pane) one_deqaResult_pane_abs).gettArea_Answer().setText(answerOfThisPanel);
                ((One_ARNSL_Style_Pane) one_deqaResult_pane_abs).gettFiled_ConfidenceRating().setText(confidenceRatingOfThisPanel);
                ((One_ARNSL_Style_Pane) one_deqaResult_pane_abs).gettField_NegativeAnswerCategory().setText(negativeAnswerCategoryOfThisPanel);
                ((One_ARNSL_Style_Pane) one_deqaResult_pane_abs).gettArea_Reason().setText(reasonOfThisPanel);
                ((One_ARNSL_Style_Pane) one_deqaResult_pane_abs).gettArea_SupportingText().setText(supportingTextOfThisPanel);
                ((One_ARNSL_Style_Pane) one_deqaResult_pane_abs).gettArea_Location().setText(locationOfThisPanel);
            }
        }
    }
